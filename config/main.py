...
TRANSFORMERS_MODELS_TO_LORA_TARGET_MODULES_MAPPING['qwen'] = ['q_proj','k_proj','v_proj',"o_proj"]
TRANSFORMERS_MODELS_TO_ADALORA_TARGET_MODULES_MAPPING['qwen'] = ['q_proj','k_proj','v_proj',"o_proj"]
TRANSFORMERS_MODELS_TO_IA3_TARGET_MODULES_MAPPING['qwen'] = ['q_proj','k_proj','v_proj',"o_proj"]
...
def get_deepspeed_config(precision='fp16'):
    ...
    #lora offload sync optimizer configuration
